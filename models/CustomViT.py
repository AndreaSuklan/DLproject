...
class CustomPretrainedViT(nn.Module):
    ...
    @classmethod
    def load_model(cls, path, img_size, patch_size, in_chans, num_classes, model_name_or_path, device=None):
        model = cls(img_size, patch_size, in_chans, num_classes, model_name_or_path)
